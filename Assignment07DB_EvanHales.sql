...
-- 08-25-2021,EvanHales,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_EvanHales')
	 Begin 
	  Alter Database [Assignment07DB_EvanHales] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_EvanHales;
	 End
	Create Database Assignment07DB_EvanHales;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_EvanHales;
...
Select
 ...
 [InventoryCount] = I.[Count]
  From vProducts as P
   ...
   Order By P.ProductName, Cast ([InventoryDate] AS DATE), [InventoryCount];
Go
...
-- Check that it works:
Select * From fProductInventoriesWithPreviousMonthCountsWithKPIs(1) Order By ProductName, InventoryDate, InventoryCount;
Select * From fProductInventoriesWithPreviousMonthCountsWithKPIs(0) Order By ProductName, InventoryDate, InventoryCount;
Select * From fProductInventoriesWithPreviousMonthCountsWithKPIs(-1) Order By ProductName, InventoryDate, InventoryCount;
